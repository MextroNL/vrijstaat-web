...
<!--        <script src="--><?php //echo get_stylesheet_directory_uri(); ?><!--/resources/Triangle/js/three.r92.min.js"></script>-->
<!--        <script src="--><?php //echo get_stylesheet_directory_uri(); ?><!--/resources/Triangle/js/vanta.fog.min.js"></script>-->

<!--        <script src="https://commandergraines.com/wp-content/themes/mextro/resources/Triangle/js/vanta.fog.min.js"></script>-->

<!--        <script src="--><?php //echo get_stylesheet_directory_uri(); ?><!--/resources/js/vanta.topology.min.js"></script>-->
<!--        <script src="--><?php //echo get_stylesheet_directory_uri(); ?><!--/resources/js/p5.min.js"></script>-->
